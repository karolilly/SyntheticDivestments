...
```{r}
ncol(luthai)
#må gjøre close_clean ikke NA for de datoene i data settet - helst et gjennomsnitt av forrige dato og neste 
...
Treatment: 2020-08-31

```{r}

fool <- rbind(luthai, baox, anan, bros, hlag, huaf, jihe, jihu, jili, luli, shch, shfu, zhse, zhwe,zhta)
...
#  special.predictors = list(list("monthly_rolling_mean", 60:100, "mean")), #new line
  ...
  time.predictors.prior = 100:182,
  time.optimize.ssr = 100:182, 
  time.plot = c(100:280), 
  )
...
path.plot(synth.res = synth.out,
          ...
          abline(v=c(164,182), col=c('blue', 'red'))) #164 her bestemmer etikkrådet #282 er det offentliggjort 
